    ...
    <div class="admin">
      ...
      <div class="admin-title">
        ...
        <div v-else-if="userIsAdmin">
          ...
          <ul>
            <li>
              - Supprimer le compte d'un membre (cliquer sur l'icône noir de la
      ...
      <p class="alert-reporting">
        ...
        Il y a
        <span class="weightbold">{{ reportedPostsCount().length }}</span>
        article(s) signalé(s)
      </p>
      <div class="table-body" tabindex="0">
        <table class="table table-striped">
        ...
        <Modal ref="modaleGetOnePost">
          ...
          <template v-slot:body>
            <div class="card-body">
              ...
              <div class="card-body-title">
                ...
                <span
                  v-if="post.tag != null || post.tag != ''"
                  :class="{ badge: post.tag }"
                >
                  Catégorie : {{ post.tag }}
                </span>
              </div>
          ...
          <template v-slot:footer>
            <div>
              <Bouton
                @click="$refs.modaleGetOnePost.closeModal()"
                text="Fermer"
              />
            </div>
          </template>
...
export default {
  ...
  methods: {
    ...
    postIsReported(id) {
      ...
      const postReported = this.allPosts.filter(
    ...
    mailToUser(id) {
      alert(
        "Vous pouvez envoyer un message privé à l'utilisateur " +
          id +
          ". Désolé mais cette fonction n'est pas encore utilisable !"
      );
    },
  },
};
