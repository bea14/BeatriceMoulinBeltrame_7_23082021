        ...
        <div class="create-container">
          <div class="body-left">
            ...
            <div class="postcreate-box">
              <div>
                Vous avez plusieurs possibilités pour votre article :
                <ul>
                  <li @click="toggleVisibility('post-create-textmedia')">
                    Du texte avec ou sans image/video : cliquer ici
                  </li>
                  <li @click="toggleVisibility('post-create-link')">
                    Un lien internet : cliquer ici
                  </li>
                  <li @click="toggleVisibility('post-create-media')">
                    Une image seule ou une vidéo seule : cliquer ici
                  </li>
                  <li>Un sondage (pas encore disponible)</li>
                </ul>
              </div>
              <Bouton
                text="Annuler et retourner aux articles"
                @click="goToPage"
                class="submitButton"
              />
            </div>
