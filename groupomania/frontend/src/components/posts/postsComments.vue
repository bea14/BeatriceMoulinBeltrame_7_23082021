  ...
  <div>
    <div class="commentdisplay">
      <div>
        ...
        />
        {{ commentData.pseudo }}, le {{ commentData.comment_date_fr }}
      </div>
      <div class="commentbox">
        ...
        <div class="commentbox-buttons">
          ...
          <button
            v-if="commentData.author == userId || userIsAdmin"
            @click.prevent="deleteComment(commentData.id)"
          >
          ...
          <router-link
            :to="{
              name: 'UpdateComment',
              params: { postId: postId, commentId: commentData.id },
            }"
          >
